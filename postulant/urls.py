...
urlpatterns = [
    ...
    url(
        r"^profile/additionalknowledges$",
        PostulantAdditionalknowledgesViewSet.as_view(get_post_bulkdelete)
    ),
    url(
        r"^profile/additionalknowledges/(?P<additionalknowledge>[0-9]+)$",
    ...
    url(
        r"^templates/doc_cv.html$",
        DocCvFormView.as_view()
    ),
    url(
